        ...
        <div id="man" class="col s12">
          <div class="card material-table">
            <div class="table-header">
              ...
              <div class="actions">
                <a href="/tcc/admin/veiculos.php" class="waves-effect btn-flat nopadding tooltipped" data-position="bottom" data-tooltip="Voltar"><i class="material-icons">arrow_back</i></a>
